...
public class ConstantLogger {
    ...
    public static final String LOG_SUCCESS_QUERY_INSERT = "Registro {}, registrado con exito";
    public static final String LOG_ERROR_QUERY_INSERT = "Error, no fue posible guardar. Causa: {}";
